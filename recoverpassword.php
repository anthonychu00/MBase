...
$mail->Username = 'memebase@gmail.com';          // SMTP username
$mail->Password = 'lk'; // SMTP password
$mail->SMTPSecure = 'tls';                  // Enable TLS encryption, `ssl` also accepted
$mail->Port = 587;                          // TCP port to connect to

$mail->setFrom('Memebase@gmail.com', 'Admin');
$mail->addReplyTo('Memebase@gmail.com', 'Admin');
