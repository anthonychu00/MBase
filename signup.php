...
else if ($_POST['password'] !== $_POST['repassword']) 
{
  echo  "<center><font color='red'>Passwords do not match </font></center>";
      ...
      if ($countusername > 0 ) {
    echo  "<center><font color='red'>Username already registered</font></center>";
}
...
$checkemail = "SELECT * FROM users WHERE email = '$email'";
      ...
      if ($countemail > 0 ) {
    echo  "<center><font color='red'>Email already registered</font></center>";
}
      ...
      $gender = $_POST['gender'];
      $joindate = date("F j, Y");
      $query = "INSERT INTO users(username,name,email,password,role,course,gender,joindate,token) VALUES ('$username' , '$name' , '$email', '$password' , '$type', '$age', '$gender' , '$joindate' , '' )";
      ...
      <div  class="form">
        <form id="contactform" method="POST"> 
          ...
          <input type="password" id="repassword" name="repassword" required=""> 
            ...
            <p class="contact"><label for="type">I am a..</label></p> 
            <select class="select-style gender" name="role">
            <option value="guest">Guest</option>
            <option value="student">Student</option>
            </select><br><br>
            
            <p class="contact"><label for="age">I am in the age range</label></p>
            <select class="select-style gender" name="course">
            <option value="Young">18-25</option>
            <option value="Middle">25-30</option>
            <option value="Old">30+</option>
            </select><br><br>
            
            <input class="buttom" name="signup" id="submit" tabindex="5" value="Sign up!" type="submit">    
   </form> 
</div>      
</div>
